...
fire_truck = Car.new()
fire_truck.ride_car()    # このままだとスコープの関係でここのride.carのメソッドが使えないので、特殊な変数を使う
```
...
たとえば赤色の車の場合、属性「color(色)」 は 「red(赤)」という属性値 を持ちます。
<img width="538" alt="スクリーンショット 2023-02-17 12 53 49" src="https://user-images.githubusercontent.com/120078794/219545390-037d5c3f-379f-4615-b253-f73c1f0c7f6f.png">

こうした個別の情報となる属性の定義には、インスタンス変数を用いる

## インスタンス変数
インスタンス、すなわちデータが持つ属性を定義する変数。  
定義しておくことですべてのインスタンスが同じ属性を持つことになるがその属性値は、個々のインスタンスによって別々に設定できる   

<img width="565" alt="スクリーンショット 2023-02-17 12 56 14" src="https://user-images.githubusercontent.com/120078794/219545705-0259032c-dc47-4b6f-be9b-8c5f916ea358.png">
